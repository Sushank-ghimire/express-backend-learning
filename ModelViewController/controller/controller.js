...
// Controllers handles and carries all of the functions that is done in the routes including CRUD operations
...
export const deleteProducts = (req, res) => {
    ...
    const index = data.products.findIndex((pro) => pro.id === productId);
    ...
    if(index !== -1) {
        ...
        res.status(404).send("Product cannot found in the database.");
    }
